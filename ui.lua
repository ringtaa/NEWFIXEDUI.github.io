...
SpeedSliderFrame.BackgroundColor3 = Theme.Button
Instance.new("UICorner", SpeedSliderFrame).CornerRadius = UDim.new(0, 6)

local SpeedSliderBar = Instance.new("Frame", SpeedSliderFrame)
SpeedSliderBar.Size = UDim2.new(0, 0, 0.6, 0) -- Expands dynamically
SpeedSliderBar.Position = UDim2.new(0, 0, 0.2, 0)
SpeedSliderBar.BackgroundColor3 = Color3.fromRGB(0, 120, 255) -- Blue fill

local SpeedSliderHandle = Instance.new("TextButton", SpeedSliderFrame)
SpeedSliderHandle.Size = UDim2.new(0, 20, 1, 0)
SpeedSliderHandle.Position = UDim2.new(0, -10, 0, 0)
SpeedSliderHandle.BackgroundColor3 = Color3.fromRGB(200, 200, 200)
SpeedSliderHandle.Text = ""

local SpeedDisplay = Instance.new("TextLabel", FeaturesTab)
SpeedDisplay.Size = UDim2.new(1, 0, 0.1, 0)
SpeedDisplay.Position = UDim2.new(0, 0, 0.48, 0)
...
SpeedSliderHandle.MouseButton1Down:Connect(function()
    ...
    connection = game:GetService("UserInputService").InputChanged:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
            local relativePosition = math.clamp((input.Position.X - SpeedSliderFrame.AbsolutePosition.X) / SpeedSliderFrame.AbsoluteSize.X, 0, 1)
            iyflyspeed = math.floor(1 + (1000 - 1) * relativePosition)
